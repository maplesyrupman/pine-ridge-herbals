            ...
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <form action="#" method="POST" className="mt-16">
                    ...
                    <div className="mt-4 space-y-4 text-sm leading-6 text-gray-600">
                      <div className="flex gap-x-2.5">
                        <input
                          ...
                          type="radio"
                          className="mt-1 h-4 w-4 border-gray-300 text-primary shadow-sm focus:ring-primary"
                        />
                ...
                <div className="mt-10 flex justify-end border-t border-gray-900/10 pt-8">
                  <button
                    type="submit"
                    className="rounded-md bg-primary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
                    Send message
                  </button>
                </div>
